...
import { JsonLdContextNormalized, IExpandOptions } from "./JsonLdContextNormalized";
/**
...
export declare class ContextParser {
     ...
     */
    expandPrefixedTerms(context: JsonLdContextNormalized, expandContentTypeToBase: boolean, keys?: string[]): void;
    /**
     ...
     */
    applyScopedProtected(context: IJsonLdContextNormalizedRaw, { processingMode }: IParseOptions, expandOptions: IExpandOptions): void;
    /**
     ...
     */
    validateKeywordRedefinitions(contextBefore: IJsonLdContextNormalizedRaw, contextAfter: IJsonLdContextNormalizedRaw, expandOptions?: IExpandOptions, keys?: string[]): void;
    /**
     ...
     */
    parseInnerContexts(context: IJsonLdContextNormalizedRaw, options: IParseOptions, keys?: string[]): Promise<IJsonLdContextNormalizedRaw>;
    /**
