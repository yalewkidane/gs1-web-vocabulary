...
const validateAnd = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateClass = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateClosed = function (context, focusNode, valueNode, constraint) {
...
const validateDatatype = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateDisjoint = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateEqualsProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateEqualsNode = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
    const equalsNode = constraint.getParameterValue(sh.equals);
...
const validateHasValueNode = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
    const hasValueNode = constraint.getParameterValue(sh.hasValue);
    return focusNode.equals(hasValueNode);
};
const validateHasValueProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
    const path = constraint.shape.pathObject;
    const hasValueNode = constraint.getParameterValue(sh.hasValue);
...
const validateIn = function (context, focusNode, valueNode, constraint) {
    return constraint.nodeSet.has(valueNode);
};
const validateLanguageIn = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
    if (valueNode.termType !== 'Literal') {
        return false;
    }
...
const validateLessThanProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
 ...
 */
const validateLessThanOrEqualsProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
    const valuePath = constraint.shape.pathObject;
    const values = getPathObjects(context.$data, focusNode, valuePath);
...
const validateMaxCountProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
    const path = constraint.shape.pathObject;
...
const validateMaxExclusive = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateMaxInclusive = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateMaxLength = function (context, focusNode, valueNode, constraint) {
...
const validateMinCountProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateMinExclusive = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateMinInclusive = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateMinLength = function (context, focusNode, valueNode, constraint) {
    if (valueNode.termType === 'BlankNode') {
        return false;
    }
    const { sh } = context.ns;
...
const validateNodeKind = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validatePattern = function (context, focusNode, valueNode, constraint) {
    if (valueNode.termType === 'BlankNode') {
        return false;
    }
    const { sh } = context.ns;
...
const validateQualifiedMaxCountProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
...
const validateQualifiedMinCountProperty = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
    const count = validateQualifiedHelper(context, focusNode, constraint);
...
const validateUniqueLangProperty = function (context, focusNode, valueNode, constraint) {
    const { sh, xsd } = context.ns;
...
const validateXone = function (context, focusNode, valueNode, constraint) {
    const { sh } = context.ns;
